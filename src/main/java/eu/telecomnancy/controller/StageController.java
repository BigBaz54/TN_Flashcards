...
public class StageController {
    ...
    public void setDeckView(DeckModel deckModel, BuildCardStrategy buildCardStrategy,
            DrawCardStrategy drawCardStrategy) {
        ...
        loader.setControllerFactory(ic -> new DeckView(deckModel, new DeckController(deckModel), this,
                buildCardStrategy, drawCardStrategy));
        try {
    ...
    public void setLearningView(Learning learning, DeckModel deckModel, BuildCardStrategy buildCardStrategy,
            DrawCardStrategy drawCardStrategy) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("LearningView.fxml"));
        loader.setControllerFactory(ic -> new LearningView(learning, deckModel, new DeckController(deckModel), this,
                buildCardStrategy, drawCardStrategy));
        try {
            Scene scene = new Scene(loader.load());
